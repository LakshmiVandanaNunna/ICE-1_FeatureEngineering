...
# Working directory
setwd('C:/Users/mohan/Desktop/UNT_Documents/Fall2021/FeatureEngineering/ICE-1/Latest-News-Classifier-master/Latest-News-Classifier-master/0. Latest News Classifier/01. Dataset Creation')

# Path definition of the news archives
path <- 'C:/Users/mohan/Desktop/UNT_Documents/Fall2021/FeatureEngineering/ICE-1/Latest-News-Classifier-master/Latest-News-Classifier-master/0. Latest News Classifier/DataCollection_Autonomous'
...
write.csv2(df_final,fileEncoding = 'utf8', "Autonomous_cars_dataset.csv", row.names = FALSE)
